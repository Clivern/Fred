 ...
 *
 * <a href="https://api.slack.com/events/file_shared">For More Info</a>
 *
 * @author Clivern
 * @since 1.0.0
 */
public class FileShared extends EventTemplate {

    protected Function<FileShared,String> callback;
     ...
     * @param callback
     */
    public FileShared(Function<FileShared,String> callback)
    {
    ...
    public Boolean isCalled()
    {
        ...
        return (requestData.has("type") && requestData.getString("type").equals("file_shared"));
    }
