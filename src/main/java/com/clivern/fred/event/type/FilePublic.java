 ...
 * File Public Event
 *
 * A file was public. It Works with RTM and Events API
 *
 * Expected scopes: files:read
 *
 * <a href="https://api.slack.com/events/file_public">For More Info</a>
 *
 * @author A.F
 * @since 1.0.0
 */
public class FilePublic extends EventTemplate {

    protected Function<FilePublic,String> callback;
     ...
     * @param callback
     */
    public FilePublic(Function<FilePublic,String> callback)
    {
    ...
    /**
     * Set Event Type. It should be file_public
     *
     * @param eventType
     */
    ...
    /**
     * Get Event Type. It should be file_public
     *
     * @return String
     */
