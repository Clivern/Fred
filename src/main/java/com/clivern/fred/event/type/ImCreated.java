 ...
 * Im Created Event
 *
 * A DM was created. It Works With RTM and Events API.
 *
 * Expected scopes: im:read
 *
 * <a href="https://api.slack.com/events/im_created">For More Info</a>
 *
 * @author A.F
 * @since 1.0.0
 */
public class ImCreated extends EventTemplate {

    protected Function<ImCreated,String> callback;
     ...
     * @param callback
     */
    public ImCreated(Function<ImCreated,String> callback)
    {
