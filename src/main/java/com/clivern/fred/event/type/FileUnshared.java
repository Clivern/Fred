...
public class FileUnshared extends EventTemplate {
    ...
    protected Function<FileUnshared,String> callback;
     ...
     * @param callback
     */
    public FileUnshared(Function<FileUnshared,String> callback)
    {
    ...
    public Boolean isCalled()
    {
        ...
        return (requestData.has("type") && requestData.getString("type").equals("file_unshared"));
    }
