 ...
 *
 * A file comment was deleted. It Works with RTM and Events API
 *
 * Expected scopes: files:read
 *
 * <a href="https://api.slack.com/events/file_comment_deleted">For More Info</a>
 *
 * @author Clivern
 * @since 1.0.0
 */
public class FileCommentDeleted extends EventTemplate {

    protected Function<FileCommentDeleted,String> callback;
     ...
     * @param callback
     */
    public FileCommentDeleted(Function<FileCommentDeleted,String> callback)
    {
        this.callback = callback;
    }

    /**
     * Set Event Type. It should be file_comment_deleted
     *
     * @param eventType
     */
    ...
    /**
     * Get Event Type. It should be file_comment_deleted
     *
     * @return String
     */
