 ...
 * @since 1.0.0
 */
public class ChannelHistoryChanged extends EventTemplate {

    protected Function<ChannelHistoryChanged,String> callback;
     ...
     * @param callback
     */
    public ChannelHistoryChanged(Function<ChannelHistoryChanged,String> callback)
    {
