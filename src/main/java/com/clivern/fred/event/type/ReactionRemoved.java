 ...
 *
 * <a href="https://api.slack.com/events/reaction_removed">For More Info</a>
 *
 * @author Clivern
 * @since 1.0.0
 */
public class ReactionRemoved extends EventTemplate {
    ...
    /**
     * Get Event Type. It should be reaction_removed
     *
     * @return String
     */
    ...
    public Boolean isCalled()
    {
        ...
        return (requestData.has("type") && requestData.getString("type").equals("reaction_removed"));
    }
