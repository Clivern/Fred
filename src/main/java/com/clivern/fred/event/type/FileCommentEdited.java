 ...
 *
 * A file comment was edited. It Works with RTM and Events API
 *
...
public class FileCommentEdited extends EventTemplate {
    ...
    protected Function<FileCommentEdited,String> callback;
     ...
     * @param callback
     */
    public FileCommentEdited(Function<FileCommentEdited,String> callback)
    {
    ...
    public Boolean isCalled()
    {
        ...
        return (requestData.has("type") && requestData.has("comment") && requestData.getString("type").equals("file_comment_edited"));
    }
