 ...
 * Group Rename Event
 *
 * A private channel was renamed. It Works with RTM and Events API
 *
...
public class GroupRename extends EventTemplate {
    ...
    protected Function<GroupRename,String> callback;
     ...
     * @param callback
     */
    public GroupRename(Function<GroupRename,String> callback)
    {
