...
public class ChannelUnarchive extends EventTemplate {
    ...
    protected Function<ChannelUnarchive,String> callback;
     ...
     * @param callback
     */
    public ChannelUnarchive(Function<ChannelUnarchive,String> callback)
    {
    ...
    /**
     * Get Event Type. It should be channel_unarchive
     *
     * @return String
     */
    ...
    public Boolean isCalled()
    {
        ...
        return (requestData.has("type") && requestData.getString("type").equals("channel_unarchive"));
    }
