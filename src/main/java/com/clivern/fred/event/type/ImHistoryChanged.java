 ...
 * @since 1.0.0
 */
public class ImHistoryChanged extends EventTemplate {

    protected Function<ImHistoryChanged,String> callback;
     ...
     * @param callback
     */
    public ImHistoryChanged(Function<ImHistoryChanged,String> callback)
    {
    ...
    /**
     * Get Event Type. It should be im_history_changed
     *
     * @return String
     */
