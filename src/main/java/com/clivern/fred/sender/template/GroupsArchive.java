 ...
 *
 * <a href="https://api.slack.com/methods/groups.archive">For More Info</a>
 *
 * @author Clivern
 * @since 1.0.0
 */
public class GroupsArchive extends BasicTemplate {
     ...
     * Class Constructor
     */
    public GroupsArchive()
    {
        this.setURL(Basic.methodURL(Basic.groupsArchiveMethod));
    }
