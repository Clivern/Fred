 ...
 *
 * <a href="https://api.slack.com/methods/groups.leave">For More Info</a>
 *
 * @author A.F
 * @since 1.0.0
 */
public class GroupsLeave extends BasicTemplate {
    ...
    public GroupsLeave()
    {
        this.setURL(Basic.methodURL(Basic.groupsLeaveMethod));
    }
