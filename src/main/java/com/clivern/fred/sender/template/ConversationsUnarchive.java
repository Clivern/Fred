...
/**
 * Conversations Unarchive Template Class
 *
 * It unarchives a conversation. The calling user is added to the conversation.
 *
 * Supported token types: user
 * Expected scopes: channels:write, groups:write, im:write, mpim:write, post
 *
 * <a href="https://api.slack.com/methods/conversations.unarchive">For More Info</a>
 *
 * @author A.F
 * @since 1.0.0
 */
