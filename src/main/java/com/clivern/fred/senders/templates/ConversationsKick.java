 ...
 *
 * It Removes a user from a conversation.
 *
 ...
 * @since 1.0.0
 */
public class ConversationsKick implements BasicTemplate {

    protected String url = Basic.methodURL(Basic.conversationsKickMethod);
