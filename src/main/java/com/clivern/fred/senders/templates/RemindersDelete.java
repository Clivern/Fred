 ...
 *
 * For More Info, Please Visit <https://api.slack.com/methods/reminders.delete>
 */
public class RemindersDelete implements BasicTemplate {

    protected String url = Basic.methodURL(Basic.remindersDeleteMethod);
