 ...
 *
 * It Sets the read cursor in a channel. It moves the read cursor in a channel.
 *
 ...
 * @since 1.0.0
 */
public class ChannelsMark extends BasicTemplate {

    protected String url = Basic.methodURL(Basic.channelsMarkMethod);
