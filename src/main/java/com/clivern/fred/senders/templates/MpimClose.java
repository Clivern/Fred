...
/**
 * Mpim Close Template Class
 *
 * It Closes a multiparty direct message channel.
 *
 * <a href="https://api.slack.com/methods/mpim.close">For More Info</a>
 *
 * @author A.F
 * @since 1.0.0
 */
public class MpimClose implements BasicTemplate {

    protected String url = Basic.methodURL(Basic.mpimCloseMethod);
