...
/**
 * Channels Archive Template Class
 *
 * For More Info, Please Visit <https://api.slack.com/methods/channels.archive>
 */
public class ChannelsArchive implements BasicTemplate {
